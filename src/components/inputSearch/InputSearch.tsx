...
export const InputSearch: FunctionComponent<InputSearchProps> = ({
    ...
    return (
        <div
            style={{ backgroundColor: simple ? '' : backgroundColor }}
        ...
        >
            ...
            />
            <button onClick={clearHandler} className={styles.closeButton}>
                <Icon name="close" size="small" className={styles.closeIcon} />
            </button>
        </div>
    )
}
