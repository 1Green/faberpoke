...
export function Pokemon({
    ...
    // Sprite logic
    const spriteKey: keyof OrientationShinyGender = getSpritesKey(
        orientation,
        shiny,
        gender
    )
    ...
    // Button logic
    const onClick = () =>
        setGender(() => (gender === 'default' ? 'female' : 'default'))
        ...
        <div className={styles.pokemonCardContainer}>
                        ...
                        .map((typeSlot) => {
                            return (
                                <PokemonType
                                    ...
                                    type={typeSlot.type}
                                    imageUrl={`./img/${typeSlot.type.name}.png`}
                                />
                            )
                        })}
                </div>
            ...
            <div className={styles.pokemonViewer}>
                <div className={styles.pokemonViewerBack}>
                    ...
                    <div
                        className={styles.pokemonButtonContainer}
                        style={{
                            justifyContent: hasFemale
                                ? 'space-between'
                                : 'flex-end',
                        }}
                    >
            ...
            <div className={styles.pokemonWeightHeightContainer}>
                <div className={styles.pokemonWeightHeight}>
                    Weight{' '}
                    <div className={styles.pokemonWeightValue}>{weight} kg</div>
                </div>

                <div className={styles.pokemonWeightHeight}>
                    Height{' '}
                    <div className={styles.pokemonHeightValue}>{height} dm</div>
                </div>
            </div>
